...
|-------------|-------------|------------|-------------------|-------|
| `docai/prod/claude-api-key` | 2026-05-31 | initial setup | 2026-08-29 | First rotation — production launch |
...
| `docai/staging/claude-api-key` | 2026-05-31 | initial setup | 2026-08-29 | First rotation — staging environment |
