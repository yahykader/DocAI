...
|-----------------------------------|---------|-----------------|------|
| `docai/prod/openai-api-key` | OpenAI GPT-4o / LLM adapter | **90 days** | BR-ROT-001 |
...
| `docai/staging/openai-api-key` | OpenAI GPT-4o / LLM adapter (staging) | **90 days** | BR-ROT-001 |
